...
public:
	...
	bool setM(MATRIX p1) const noexcept { return (MV1SetMatrix(this->handle_,p1) == 0); }

	bool draw(void) const noexcept { return (MV1DrawModel(this->handle_)==0); }
	bool draw(int mesh) const noexcept { return (MV1DrawMesh(this->handle_,mesh)==0); }
